...
public class ComprasDetallesResourceRESTService {
    ...
    private void validateCompraDetalle(CompraDetalle compraDetalle) throws ConstraintViolationException, ValidationException {
        // Create a bean validator and check for issues.
        Set<ConstraintViolation<CompraDetalle>> violations = validator.validate(compraDetalle);
