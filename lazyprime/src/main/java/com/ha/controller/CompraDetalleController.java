...
public class CompraDetalleController {
    ...
    public void agregarACarrito(Product product){
    ...
    public void register(CompraDetalle compraDetalle) throws Exception {
        try {
            ...
            compraDetalleRegistration.register(newCompraDetalle);
            facesContext.addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO, "Producto agregada al carrito!", "Registration successful"));
            initNewCompraDetalle();
        } catch (Exception e) {
    ...
    @PostConstruct
    public void initNewCompraDetalle() {
        newCompraDetalle = new CompraDetalle();
    }
